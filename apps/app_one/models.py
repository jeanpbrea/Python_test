...
class Poke(models.Model):
    poker = models.ForeignKey(User, related_name='pokes_done',  on_delete = models.CASCADE)
    rpoke = models.ForeignKey(User, related_name='pokes_gotten',  on_delete = models.CASCADE)
    created_at = models.DateTimeField(auto_now_add = True)
    updated_at = models.DateTimeField(auto_now = True)
    objects = pokeManager()